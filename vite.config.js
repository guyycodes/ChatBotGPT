...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'ChatBotGPT',
        short_name: 'ChatGPT',
        description: 'Talk to Chat A.i from a simple downloadable cross platform application',
        theme_color: '#ffffff',
        background_color: '#ffffff',
        display: 'standalone',
        start_url: '/ChatBotGPT/', // start URL for GitHub Pages
        id: '/ChatBotGPT/', //  a consistent ID for the app
        scope: '/ChatBotGPT/', // the scope to restrict what URLs are considered part of the app
        icons: [
  ...
  build: {
    ...
    base: '/ChatBotGPT/', // Base public path set to match the GitHub repository name
  },
});